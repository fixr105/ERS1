...
export const NoiseBackground = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'group relative overflow-hidden rounded-full bg-neutral-900 p-2',
        'shadow-[0px_0.5px_1px_0px_rgba(163,163,163,0.8)_inset,0px_1px_0px_0px_rgba(245,245,245,1)]',
        'dark:shadow-[0px_1px_0px_0px_rgba(10,10,10,1)_inset,0px_1px_0px_0px_rgba(38,38,38,1)]',
        backdropBlur &&
    ...
    >
      ...
      <motion.div
        className="absolute inset-x-0 top-0 h-1 rounded-t-full opacity-80 blur-sm"
        style={{
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <img
          ...
          style={{ mixBlendMode: 'overlay', opacity: noiseIntensity }}
        />
      </div>

      <div className={cn('relative z-10 h-full w-full rounded-full bg-black', className)}>
        {children}
      </div>
    </div>
  );
